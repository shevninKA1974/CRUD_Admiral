...
`},w1={spinner:100,tooltip:100,notification:99,hint:98,dropdown:97,modal:96,drawer:96},Zc={firstDayOfWeek:1,badge:{amountAriaLabel:"Amount"},calendar:{backwardText:"Back",forwardText:"Forward",nextMonthText:"Next month",previousMonthText:"Previous month",returnText:"Return",selectYearText:"Select year",selectMonthText:"Select month"},fileInput:{metricUnits:["Kb","Mb","Gb"]},groupActionsPane:{inputPlaceholder:"Search in table"},hint:{closeButtonAriaLabel:"Close the hint"},modal:{closeButtonAriaLabel:"Close the modal window"},paginationOne:{itemsPerPageText:"Entries on the page:",pageSelectLabel:(e,t)=>`Page ${e} of ${t}`,pageSizeSelectLabel:(e,t)=>`Entries ${e} out of ${t}`,itemRangeText:(e,t,n)=>`${e}–${t}  entries out of ${n}`,pageRangeText:e=>`from ${e} ${e===1?"page":"pages"}`,backwardText:"Previous page, select",forwardText:"Next page, select"},paginationTwo:{inputPlaceholder:"Page number",itemRangeText:(e,t,n)=>`${e}–${t} entries out of ${n}`},progressStepper:{renderNextStepName:e=>`Next - ${e}`,stepName:["step","steps"],progressText:(e,t,n)=>`${e} from ${t} ${n}`},select:{emptyMessage:"No matches"},suggestInput:{emptyMessage:"No matches"},table:{emptyMessage:"No matches"}},S1={ru:{firstDayOfWeek:1,badge:{amountAriaLabel:"Количество"},calendar:{backwardText:"Назад",forwardText:"Вперед",nextMonthText:"Следующий месяц",previousMonthText:"Предыдущий месяц",returnText:"Вернуться",selectYearText:"Выбор года",selectMonthText:"Выбор месяца"},fileInput:{metricUnits:["Кб","Мб","Гб"]},groupActionsPane:{inputPlaceholder:"Искать в таблице"},hint:{closeButtonAriaLabel:"Закрыть подсказку"},modal:{closeButtonAriaLabel:"Закрыть модальное окно"},paginationOne:{itemsPerPageText:"Записей на странице:",pageSelectLabel:(e,t)=>`Страница ${e} из ${t}`,pageSizeSelectLabel:(e,t)=>`Записей ${e} из ${t}`,itemRangeText:(e,t,n)=>`${e}–${t} записей из ${n}`,pageRangeText:e=>`из ${e} ${e===1?"страницы":"страниц"}`,backwardText:"Предыдущая страница, выбрать",forwardText:"Следующая страница, выбрать"},paginationTwo:{inputPlaceholder:"№ страницы",itemRangeText:(e,t,n)=>`${e}–${t} записей из ${n}`},progressStepper:{renderNextStepName:e=>`Далее - ${e}`,stepName:["шаг","шагов"],progressText:(e,t,n)=>`${e} из ${t} ${n}`},select:{emptyMessage:"Нет совпадений"},suggestInput:{emptyMessage:"Нет совпадений"},table:{emptyMessage:"Нет совпадений"}},en:Zc,"en-US":{...Zc,firstDayOfWeek:0}},mu={color:y1,shadow:x1,zIndex:w1,name:"light",shape:{borderRadiusKind:"Border radius 4"},currentLocale:"ru",locales:S1};function fl(e){switch(e.borderRadiusKind){case"Border radius 0":return"0";case"Border radius 2":return"2px";default:return"4px"}}function No(e){switch(e.borderRadiusKind){case"Border radius 0":return"0";case"Border radius 2":return"2px";case"Border radius 4":default:return"4px";case"Border radius 6":return"6px";case"Border radius 8":return"8px";case"Border radius 10":return"10px"}}function $1(e){switch(e.borderRadiusKind){case"Border radius 0":return"0";case"Border radius 2":return"4px";case"Border radius 4":default:return"8px";case"Border radius 6":return"12px";case"Border radius 8":return"16px";case"Border radius 10":return"20px"}}function qc(e){return e!==null&&!Array.isArray(e)&&typeof e=="object"}const Di={3:"Cancel",6:"Help",8:"Backspace",9:"Tab",12:"Clear",13:"Enter",16:"Shift",17:"Control",18:"Alt",19:"Pause",20:"CapsLock",27:"Escape",28:"Convert",29:"NonConvert",30:"Accept",31:"ModeChange",32:" ",33:"PageUp",34:"PageDown",35:"End",36:"Home",37:"ArrowLeft",38:"ArrowUp",39:"ArrowRight",40:"ArrowDown",41:"Select",42:"Print",43:"Execute",44:"PrintScreen",45:"Insert",46:"Delete",48:["0",")"],49:["1","!"],50:["2","@"],51:["3","#"],52:["4","$"],53:["5","%"],54:["6","^"],55:["7","&"],56:["8","*"],57:["9","("],91:"OS",93:"ContextMenu",144:"NumLock",145:"ScrollLock",181:"VolumeMute",182:"VolumeDown",183:"VolumeUp",186:[";",":"],187:["=","+"],188:[",","<"],189:["-","_"],190:[".",">"],191:["/","?"],192:["`","~"],219:["[","{"],220:["\\","|"],221:["]","}"],222:["'",'"'],224:"Meta",225:"AltGraph",246:"Attn",247:"CrSel",248:"ExSel",249:"EraseEof",250:"Play",251:"ZoomOut"};for(let e=0;e<24;e+=1)Di[112+e]="F"+(e+1);for(let e=0;e<26;e+=1){let t=e+65;Di[t]=[String.fromCharCode(t+32),String.fromCharCode(t)]}const O={codes:Di,getCode(e){return qc(e)?e.keyCode||e.which||this[e.key]:this[e]},getKey(e){const t=qc(e);if(t&&e.key)return e.key;let n=Di[t?e.keyCode||e.which:e];return Array.isArray(n)&&(n=t?n[e.shiftKey?1:0]:n[0]),n},Cancel:3,Help:6,Backspace:8,Tab:9,Clear:12,Enter:13,Shift:16,Control:17,Alt:18,Pause:19,CapsLock:20,Escape:27,Convert:28,NonConvert:29,Accept:30,ModeChange:31," ":32,PageUp:33,PageDown:34,End:35,Home:36,ArrowLeft:37,ArrowUp:38,ArrowRight:39,ArrowDown:40,Select:41,Print:42,Execute:43,PrintScreen:44,Insert:45,Delete:46,0:48,")":48,1:49,"!":49,2:50,"@":50,3:51,"#":51,4:52,$:52,5:53,"%":53,6:54,"^":54,7:55,"&":55,8:56,"*":56,9:57,"(":57,a:65,A:65,b:66,B:66,c:67,C:67,d:68,D:68,e:69,E:69,f:70,F:70,g:71,G:71,h:72,H:72,i:73,I:73,j:74,J:74,k:75,K:75,l:76,L:76,m:77,M:77,n:78,N:78,o:79,O:79,p:80,P:80,q:81,Q:81,r:82,R:82,s:83,S:83,t:84,T:84,u:85,U:85,v:86,V:86,w:87,W:87,x:88,X:88,y:89,Y:89,z:90,Z:90,OS:91,ContextMenu:93,F1:112,F2:113,F3:114,F4:115,F5:116,F6:117,F7:118,F8:119,F9:120,F10:121,F11:122,F12:123,F13:124,F14:125,F15:126,F16:127,F17:128,F18:129,F19:130,F20:131,F21:132,F22:133,F23:134,F24:135,NumLock:144,ScrollLock:145,VolumeMute:181,VolumeDown:182,VolumeUp:183,";":186,":":186,"=":187,"+":187,",":188,"<":188,"-":189,_:189,".":190,">":190,"/":191,"?":191,"`":192,"~":192,"[":219,"{":219,"\\":220,"|":220,"]":221,"}":221,"'":222,'"':222,Meta:224,AltGraph:225,Attn:246,CrSel:247,ExSel:248,EraseEof:249,Play:250,ZoomOut:251};O.Spacebar=O[" "],O.Digit0=O[0],O.Digit1=O[1],O.Digit2=O[2],O.Digit3=O[3],O.Digit4=O[4],O.Digit5=O[5],O.Digit6=O[6],O.Digit7=O[7],O.Digit8=O[8],O.Digit9=O[9],O.Tilde=O["~"],O.GraveAccent=O["`"],O.ExclamationPoint=O["!"],O.AtSign=O["@"],O.PoundSign=O["#"],O.PercentSign=O["%"],O.Caret=O["^"],O.Ampersand=O["&"],O.PlusSign=O["+"],O.MinusSign=O["-"],O.EqualsSign=O["="],O.DivisionSign=O["/"],O.MultiplicationSign=O["*"],O.Comma=O[","],O.Decimal=O["."],O.Colon=O[":"],O.Semicolon=O[";"],O.Pipe=O["|"],O.BackSlash=O["\\"],O.QuestionMark=O["?"],O.SingleQuote=O["'"],O.DoubleQuote=O['"'],O.LeftCurlyBrace=O["{"],O.RightCurlyBrace=O["}"],O.LeftParenthesis=O["("],O.RightParenthesis=O[")"],O.LeftAngleBracket=O["<"],O.RightAngleBracket=O[">"],O.LeftSquareBracket=O["["],O.RightSquareBracket=O["]"];var Jc;function Ka(){return Ka=Object.assign?Object.assign.bind():function(e){for(var t=1;t<arguments.length;t++){var n=arguments[t];for(var r in n)Object.prototype.hasOwnProperty.call(n,r)&&(e[r]=n[r])}return e},Ka.apply(this,arguments)}var k1=function(e){return x.createElement("svg",Ka({xmlns:"http://www.w3.org/2000/svg",fill:"none",viewBox:"0 0 24 24"},e),Jc||(Jc=x.createElement("path",{fill:"#717681",d:"M5.226 8.56c0-.18.07-.35.21-.48.27-.24.68-.22.92.04l5.74 6.37 5.55-6.41a.65.65 0 0 1 .92-.04c.26.24.28.65.04.92l-5.99 6.9c-.28.31-.76.31-1.04 0L5.396 9a.627.627 0 0 1-.17-.44Z"})))};const Q="'VTB Group UI', sans-serif",he={"Main/XXL":_`
  ...
  `,"Caption/Caption 2":_`
    ...
    font-feature-settings:
      ...
      'lnum' on;
    text-rendering: geometricPrecision;
  `};var ed;function Xa(){return Xa=Object.assign?Object.assign.bind():function(e){for(var t=1;t<arguments.length;t++){var n=arguments[t];for(var r in n)Object.prototype.hasOwnProperty.call(n,r)&&(e[r]=n[r])}return e},Xa.apply(this,arguments)}var sh=function(e){return x.createElement("svg",Xa({xmlns:"http://www.w3.org/2000/svg",fill:"none",viewBox:"0 0 24 24"},e),ed||(ed=x.createElement("path",{fill:"#717681",d:"M6.41 5.49a.65.65 0 1 0-.92.92L11.08 12l-5.49 5.49a.65.65 0 0 0 .92.92L12 12.92l5.49 5.49a.65.65 0 0 0 .92-.92L12.92 12l5.59-5.59a.65.65 0 0 0-.92-.92L12 11.08 6.41 5.49Z"})))};const E1=24,P1=20,C1=16,N1=6,T1=4;function yo(e){switch(e){case"lSmall":case"lBig":default:return E1;case"mSmall":case"mBig":return P1;case"s":return C1}}function uh(e){switch(e){case"lBig":case"mBig":default:return N1;case"lSmall":case"mSmall":case"s":return T1}}function td(e){return yo(e)+2*uh(e)}const _1=_`
  & *[fill^='#'] {
...
`,ch=x.forwardRef(({type:e="button",dimension:t="lBig",disabled:n=!1,highlightFocus:r=!0,appearance:o,children:i,...l},a)=>{const s=typeof o=="object"?o.iconColor?o.iconColor:"secondary":o;return y.jsxs(j1,{ref:a,type:e,$dimension:t,disabled:n,$highlightFocus:r,...l,children:[y.jsx(Dr,{$dimension:t,"aria-hidden":!0}),y.jsx(M1,{$dimension:t,$iconColor:s,"aria-hidden":!0,children:i})]})}),O1=x.forwardRef(({className:e,...t},n)=>y.jsx(ch,{ref:n,className:`close-button ${e||""}`,...t,children:y.jsx(sh,{"aria-hidden":!0})}));function Ct(...e){return t=>{e.forEach(n=>{n&&(typeof n=="function"?n(t):n.current=t)})}}const Ii=()=>{let e=0;const t=document.createElement("div");return t.innerHTML=`Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diem 
    ...
    lobortis nisl ut aliquip ex ea commodo consequat.`,t.style.overflow="scroll",t.style.fontSize="14px",t.style.height="50px",t.style.maxHeight="50px",t.style.width="100px",t.style.position="absolute",t.style.top="-100000px",t.style.left="-100000px",document.body.appendChild(t),e=t.offsetWidth-t.clientWidth,document.body.removeChild(t),e||16},F1=["bottom","height","left","right","top","width"];function gu(e,t){const n={};return{observe(){n.rafId&&cancelAnimationFrame(n.rafId);const r=()=>{if(n.isObserving){const{bottom:o,height:i,left:l,right:a,top:s,width:c,x:d,y:f}=e.getBoundingClientRect(),h={bottom:o,height:i,left:l,right:a,top:s,width:c,x:d||l,y:f||s};((v={},g={})=>F1.some($=>v[$]!==g[$]))(h,n.rect)&&(n.rect=h,t(n.rect)),n.rafId=requestAnimationFrame(r)}};n.rafId=requestAnimationFrame(r),n.isObserving=!0},unobserve(){n.rafId&&cancelAnimationFrame(n.rafId),n.isObserving&&(n.isObserving=!1)}}}const L1=j.div`
  pointer-events: none;
  position: fixed;
  overflow: visible;
  z-index: ${({theme:e})=>e.zIndex.dropdown};
`,dh=({targetRef:e,targetElement:t,rootRef:n,fullContainerWidth:r,...o})=>{const i=x.useRef(null);return x.useEffect(()=>{const l=i.current,a=t??(e==null?void 0:e.current);if(l&&a){const s=gu(a,c=>{if(c){const{x:d,y:f,height:h,width:v}=c,{style:g}=l;g.top=`${f}px`,g.left=r?"0px":`${d}px`,g.height=`${h}px`,g.width=r?"100%":`${v}px`}});return s.observe(),()=>{s.unobserve()}}},[e,t,r]),ll.createPortal(y.jsx(L1,{ref:i,...o}),(n==null?void 0:n.current)||document.body)},z1=j.div`
  box-sizing: border-box;
  opacity: 0;
...
`,Ue=8;function I1(e,t,n,r){const o=e.getBoundingClientRect(),i=t.getBoundingClientRect(),l=Object.entries(function(c){return{bottom:{check:(d,f)=>{const h=window.innerHeight-d.bottom-c>Ue+f.height,v=d.left+d.width/2>f.width/2,g=window.innerWidth-d.right-c+d.width/2>f.width/2;return h&&v&&g}},top:{check:(d,f)=>{const h=d.top>Ue+f.height,v=d.left+d.width/2>f.width/2,g=window.innerWidth-d.right-c+d.width/2>f.width/2;return h&&v&&g}},left:{check:(d,f)=>{const h=d.left>Ue+f.width,v=d.top>(f.height-d.height)/2,g=window.innerHeight-d.bottom-c>(f.height-d.height)/2;return h&&g&&v}},right:{check:(d,f)=>{const h=window.innerWidth-d.right-c>Ue+f.width,v=d.top>(f.height-d.height)/2,g=window.innerHeight-d.bottom-c>(f.height-d.height)/2;return h&&g&&v}},bottomRight:{check:(d,f)=>{const h=window.innerHeight-d.bottom-c>Ue+f.height,v=window.innerWidth-d.left-c>f.width;return h&&v}},bottomLeft:{check:(d,f)=>{const h=window.innerHeight-d.bottom-c>Ue+f.height,v=d.right>f.width;return h&&v}},topRight:{check:(d,f)=>{const h=d.top>Ue+f.height,v=window.innerWidth-d.left-c>f.width;return h&&v}},topLeft:{check:(d,f)=>{const h=d.top>Ue+f.height,v=d.right>f.width;return h&&v}},leftBottom:{check:(d,f)=>{const h=d.left>Ue+f.width,v=window.innerHeight-d.top-c>f.height;return h&&v}},leftTop:{check:(d,f)=>{const h=d.left>Ue+f.width,v=d.bottom>f.height;return h&&v}},rightBottom:{check:(d,f)=>{const h=window.innerWidth-d.right-c>Ue+f.width,v=window.innerHeight-d.top-c>f.height;return h&&v}},rightTop:{check:(d,f)=>{const h=window.innerWidth-d.right-c>Ue+f.width,v=d.bottom>f.height;return h&&v}},bottomPageCenter:{check:(d,f)=>{const h=window.innerHeight-d.bottom-c>Ue+f.height,v=window.innerWidth-c>=f.width;return h&&v}},topPageCenter:{check:(d,f)=>{const h=d.top>Ue+f.height,v=window.innerWidth-c>=f.width;return h&&v}}}}(n)),a=r?l.filter(c=>c[0].includes(r)&&c[1].check(o,i)):l.filter(c=>c[1].check(o,i)),s=r||"bottom";return a.length?a[0][0]:s}const To=x.createContext({}),b1=({rootRef:e,...t})=>{const[n,r]=x.useState([]),[o,i]=x.useState(void 0),l=x.useCallback(f=>{i(f)},[]),a=x.useCallback(f=>{i(h=>h===f?void 0:h)},[]),s=x.useCallback(f=>{r(h=>{const v=h.indexOf(f);return v>-1?h.slice(0,v):h})},[]),c=x.useCallback(f=>{r(h=>[...h,f])},[]),d=x.useMemo(()=>({addDropdown:c,removeDropdown:s,dropdowns:n,rootRef:e,activateMenu:l,deactivateMenu:a,currentActiveMenu:o}),[c,s,n,e,l,a,o]);return y.jsx(To.Provider,{value:d,children:t.children})};function B1(e){const{dropdowns:t=[],addDropdown:n,removeDropdown:r,activateMenu:o,deactivateMenu:i,currentActiveMenu:l}=x.useContext(To),a=t.indexOf(e);return{addDropdown:n,removeDropdown:r,dropdowns:a>-1?t.slice(a+1,t.length):[],activateMenu:o,deactivateMenu:i,currentActiveMenu:l}}const W1=(e,t)=>!t.some(n=>n.current&&n.current.contains(e.target)),vu=x.forwardRef(({renderContent:e,targetRef:t,targetElement:n,tooltipPosition:r,...o},i)=>{const l=x.useRef(null),a=x.useRef(0),{rootRef:s}=x.useContext(To),c=x.useMemo(()=>!e()&&e()!==0,[e]),[d,f]=x.useState(""),[h,v]=x.useState(!1),[g,$]=x.useState({});return x.useEffect(()=>{(k=>{const p=n??(t==null?void 0:t.current);if(p&&l.current){const u=I1(p,l.current,k,r),m=l.current;switch(u){case"leftBottom":case"leftTop":case"left":f("row-reverse"),v(!1),m.style.margin="0 8px 0 0",m.style.alignSelf=u==="leftBottom"?"flex-start":u==="leftTop"?"flex-end":"center";break;case"rightBottom":case"rightTop":case"right":f("row"),v(!1),m.style.margin="0 0 0 8px",m.style.alignSelf=u==="rightBottom"?"flex-start":u==="rightTop"?"flex-end":"center";break;case"topPageCenter":case"topLeft":case"topRight":case"top":f("column-reverse"),v(u==="topPageCenter"),m.style.margin="0 0 8px 0",m.style.alignSelf=u==="topLeft"?"flex-end":u==="topRight"?"flex-start":"center";break;default:f("column"),v(u==="bottomPageCenter"),m.style.margin="8px 0 0 0",m.style.alignSelf=u==="bottomLeft"?"flex-end":u==="bottomRight"?"flex-start":"center"}}})(Ii())},[e(),t,n,r,g]),x.useLayoutEffect(()=>{if(l.current&&!c){const k=new ResizeObserver(p=>{p.forEach(u=>{a.current===0?a.current=u.contentRect.height:$({})})});return k.observe(l.current),()=>{k.disconnect()}}},[c]),x.useEffect(()=>{l.current&&!c&&(l.current.style.opacity="1")},[c]),c?null:y.jsxs(D1,{targetElement:n??(t==null?void 0:t.current),rootRef:s,$flexDirection:d,fullContainerWidth:h,children:[y.jsx(A1,{}),y.jsx(z1,{ref:Ct(i,l),children:y.jsx(R1,{role:"tooltip",...o,children:e()})})]})});vu.displayName="Tooltip";const H1=_`
...
`,G1=_`
  ${({$dimension:e})=>e==="s"?he["Body/Body 2 Long"]:he["Body/Body 1 Long"]}
`,Q1=_`
...
`,sd=j.div`
  display: inline-block;
  width: 2px;
`,bi=x.forwardRef(({appearance:e="primary",dimension:t="xl",type:n="button",loading:r=!1,skeleton:o=!1,iconStart:i,iconEnd:l,icon:a,iconPlace:s="left",children:c,buttonCssMixin:d,displayAsDisabled:f,displayAsSquare:h,...v},g)=>{const $=!!i||!!a&&s==="left",k=!!l||!!a&&s==="right",p=(h||$?0:2)+(h||k?0:2);return y.jsxs(hv,{ref:g,$appearance:e,$dimension:t,type:n,$loading:r,$skeleton:o,$buttonCssMixin:d,$displayAsSquare:h,$displayAsDisabled:f,...v,children:[r&&y.jsx(pv,{dimension:t==="s"?"ms":"m",inverse:e!=="secondary"&&e!=="ghost"}),!h&&!$&&y.jsx(sd,{}),y.jsxs(ph,{$addPadding:p,children:[$?y.jsx(xo,{children:i||a}):null,x.Children.toArray(c).map((u,m)=>typeof u=="string"?y.jsx("div",{children:u},u+m):u),k?y.jsx(xo,{children:l||a}):null]}),!h&&!k&&y.jsx(sd,{})]})}),hv=j.button.attrs(e=>({"data-dimension":e.$dimension,"data-appearance":[e.$appearance,e.$displayAsDisabled?"disabled":void 0].filter(t=>t!==void 0).join(" ")}))`
  position: relative;
  box-sizing: border-box;
  display: inline-block;
  white-space: nowrap;
...
`;bi.displayName="Button";var ud;function rs(){return rs=Object.assign?Object.assign.bind():function(e){for(var t=1;t<arguments.length;t++){var n=arguments[t];for(var r in n)Object.prototype.hasOwnProperty.call(n,r)&&(e[r]=n[r])}return e},rs.apply(this,arguments)}var mv=function(e){return x.createElement("svg",rs({xmlns:"http://www.w3.org/2000/svg",fill:"none",viewBox:"0 0 16 16"},e),ud||(ud=x.createElement("path",{fill:"#fff",d:"M13.471 5.805a.667.667 0 1 0-.942-.943L7 10.39 4.138 7.53a.667.667 0 0 0-.943.942l3.334 3.334c.26.26.682.26.942 0l6-6Z"})))},cd;function os(){return os=Object.assign?Object.assign.bind():function(e){for(var t=1;t<arguments.length;t++){var n=arguments[t];for(var r in n)Object.prototype.hasOwnProperty.call(n,r)&&(e[r]=n[r])}return e},os.apply(this,arguments)}var gv=function(e){return x.createElement("svg",os({xmlns:"http://www.w3.org/2000/svg",fill:"none",viewBox:"-5 -9 20 20"},e),cd||(cd=x.createElement("rect",{width:10,height:2,fill:"#fff",rx:1})))};const vv=_`
...
`,Qv=j.input`
  ...
  ${e=>e.$dimension==="s"?he["Body/Body 2 Long"]:he["Body/Body 1 Long"]}
...
`,Kv=j(Nv)`
  ${Vv}
`;function Xv(e){return e||{}}const Zv=e=>e.preventDefault(),ss=x.forwardRef(({dimension:e,type:t,displayClearIcon:n,isLoading:r,status:o,handleInput:i=Xv,containerRef:l,icons:a,children:s,className:c,style:d,placeholder:f,skeleton:h=!1,showTooltip:v=!0,...g},$)=>{const k=x.useRef(null),p=l||x.useRef(null),u=x.Children.toArray(a),[m,w]=x.useState(!1),[S,E]=x.useState(!1),[P,T]=x.useState(g.defaultValue??void 0),W=g.value??P;x.useEffect(()=>{$n(k.current)?w(!0):w(!1)},[S,w]),x.useLayoutEffect(()=>{function X(){document.activeElement!==k.current&&E(!0)}function fe(){E(!1)}const Z=p.current;if(Z)return Z.addEventListener("mouseenter",X),Z.addEventListener("mouseleave",fe),Z.addEventListener("mousedown",fe),()=>{Z.removeEventListener("mouseenter",X),Z.removeEventListener("mouseleave",fe),Z.removeEventListener("mousedown",fe)}},[E]);const[A,K]=x.useState(!1);if(!g.readOnly&&t==="password"){const X=A?Bv:bv;u.push(y.jsx(vd,{icon:X,onClick:()=>{K(!A)},"aria-hidden":!0},"eye-icon"))}!g.readOnly&&n&&W&&u.unshift(y.jsx(vd,{icon:sh,onClick:()=>{k.current&&jr(k.current,{value:""})},"aria-hidden":!0},"clear-icon")),r&&u.unshift(y.jsx(yu,{dimension:e==="s"?"ms":"m"},"loading-icon"));const le=u.length;return x.useLayoutEffect(()=>{const X=i(null);function fe(){const{value:Z,selectionStart:D,selectionEnd:b}=this,C=i({value:Z,selectionStart:D,selectionEnd:b});f&&!is(X,C)?jr(this,{...C,value:""}):jr(this,C)}if(t!=="date"&&k.current){const Z=k.current;Z.addEventListener("input",fe);const{value:D,selectionStart:b,selectionEnd:C}=Z,F=i({value:D,selectionStart:b,selectionEnd:C});return f&&!is(X,F)?jr(Z,{...F,value:""}):jr(Z,F),()=>{Z.removeEventListener("input",fe)}}},[i,f]),y.jsxs(y.Fragment,{children:[y.jsxs(Kv,{className:c,style:d,$dimension:e,ref:p,disabled:g.disabled,readOnly:g.readOnly,$status:o,"data-disabled":!!g.disabled||void 0,"data-read-only":!!g.readOnly||void 0,"data-status":o,$skeleton:h,"data-disable-copying":!!g.disableCopying||void 0,...g.disableCopying&&{onMouseDown:Zv},children:[y.jsx(Qv,{ref:Ct($,k),...g,onChange:X=>{var fe;T(X.currentTarget.value),(fe=g.onChange)==null||fe.call(g,X)},placeholder:f,$dimension:e,$iconCount:le,type:t==="password"&&A?"text":t}),y.jsx(or,{$status:o,disabled:g.disabled||g.readOnly}),le>0&&y.jsx(Yv,{disabled:g.disabled,$dimension:e,children:u}),s]}),v&&S&&m&&y.jsx(vu,{renderContent:()=>{var X;return((X=k==null?void 0:k.current)==null?void 0:X.value)||""},targetElement:p.current})]})});ss.defaultProps={dimension:"m"},ss.displayName="TextInput";const qv=(e,t)=>{const n=x.useCallback(r=>{e.every(o=>o.current&&!o.current.contains(r.target))&&t(r)},[t,e]);x.useEffect(()=>(document.addEventListener("mousedown",n,!0),document.addEventListener("touchstart",n),()=>{document.removeEventListener("mousedown",n,!0),document.removeEventListener("touchstart",n)}),[n])};function Jv(e,t){const n=x.useRef(null),r=x.useRef(e);return x.useEffect(()=>{r.current=e},[e]),x.useEffect(()=>{if(typeof t=="number")return n.current=window.setInterval(()=>r.current(),t),()=>window.clearInterval(n.current||0)},[t]),n}const ey=j.div`
  pointer-events: initial;
  margin: 8px 0;
  flex: 0 0 auto;
...
`,ny=j(dh)`
  ...
  flex-wrap: nowrap;
`,yh=x.forwardRef(({targetRef:e,targetElement:t,onClickOutside:n=()=>null,className:r="",alignSelf:o,dropContainerCssMixin:i,...l},a)=>{const s=x.useRef(null),[c,d]=x.useState(!1),f=t??(e==null?void 0:e.current),{addDropdown:h,removeDropdown:v,dropdowns:g}=B1(s),{rootRef:$}=x.useContext(To);qv([s],p=>{W1(p,g)&&n(p)}),x.useLayoutEffect(()=>{var p;s.current!==document.activeElement&&((p=s==null?void 0:s.current)==null||p.focus())},[]);const k=x.useCallback(()=>{const p=s.current;if(p&&f){const u=p.getBoundingClientRect(),m=f.getBoundingClientRect(),w=window.innerHeight,S=window.innerWidth;if(w-u.bottom<0&&m.top>w-m.bottom?c||d(!0):(m.bottom+(m.top-u.top)<w-8||m.top<w-m.bottom)&&c&&d(!1),o&&o!=="auto")return;const E=u.right-u.left,P=S-m.left>=E,T=m.right-16>=E,W=E>m.width;if(T||P)p.style.transform="translateX(0)",T&&P?p.style.alignSelf="flex-end":W&&!T&&P?p.style.alignSelf="flex-start":W&&!P&&T&&(p.style.alignSelf="flex-end");else{p.style.alignSelf="center";const A=(S-u.width)/2-(m.left-(E-m.width)/2);p.style.transform=`translateX(${A}px)`}}},[c,e,t]);return Jv(k,100),x.useEffect(()=>{s.current&&(s.current.style.opacity="1")},[]),x.useLayoutEffect(()=>(h==null||h(s),()=>{v==null||v(s)}),[]),y.jsx(y.Fragment,{children:y.jsxs(ny,{targetElement:f,$reverse:c,rootRef:$,children:[y.jsx(ty,{}),y.jsx(ey,{ref:Ct(a,s),...l,className:r+" dropdown-container",$alignSelf:o,$dropContainerCssMixin:i})]})})});yh.displayName="DropdownContainer";const xh=j(yh)`
  ${e=>e.theme.shadow["Shadow 08"]}
  border-radius: ${e=>No(e.theme.shape)};
  overflow: hidden;
  width: max-content;
`;xh.displayName="StyledDropdownContainer";const ry=(e,t)=>{let n,r=!1,o=!1;return[(...i)=>{if(o||r)return;const l=e(...i);return r=!0,n=window.setTimeout(()=>{r=!1},t),l},()=>{o=!0,clearTimeout(n)}]};function oy(e,t){wh(e,t,"data-container",!0)}function iy(e,t){wh(e,t,"data-field",!1)}function wh(e,t,n,r){Object.keys(e).forEach(o=>{typeof o=="string"&&o.startsWith(n)&&(t[o]=e[o],r&&delete e[o])})}function ly(e=document){return[...e.querySelectorAll('a, button, input, textarea, select, details,[tabindex]:not([tabindex="-1"])')].filter(t=>!t.hasAttribute("disabled"))}const Ir=x.forwardRef((e,t)=>{const n=x.useRef(null),{className:r,maxLength:o,displayInline:i,status:l,required:a,extraText:s,label:c,id:d=hh(),disabled:f,displayCharacterCounter:h,skeleton:v,...g}=e,$={className:r,extraText:s,status:l,required:a,label:c,id:d,displayInline:i,disabled:f,maxLength:o,inputRef:n,displayCharacterCounter:h,skeleton:v,"data-field-id":d,"data-field-name":g.name};iy(g,$),oy(g,$);const k={ref:Ct(t,n),id:d,"aria-required":a,status:l,disabled:f,maxLength:o,skeleton:v,...g};return y.jsx(gh,{...$,children:y.jsx(ss,{...k})})});Ir.displayName="InputField";var yd;function us(){return us=Object.assign?Object.assign.bind():function(e){for(var t=1;t<arguments.length;t++){var n=arguments[t];for(var r in n)Object.prototype.hasOwnProperty.call(n,r)&&(e[r]=n[r])}return e},us.apply(this,arguments)}var ay=function(e){return x.createElement("svg",us({xmlns:"http://www.w3.org/2000/svg",fill:"none",viewBox:"0 0 24 24"},e),yd||(yd=x.createElement("path",{fill:"#717681",d:"M5 10a2 2 0 1 1 0 4 2 2 0 0 1 0-4Zm14 0a2 2 0 1 1 0 4 2 2 0 0 1 0-4Zm-5 2a2 2 0 1 0-4 0 2 2 0 0 0 4 0Z"})))};const cs=e=>e&&e.ownerDocument||document,ds=e=>cs(e).defaultView||window,xd=e=>parseInt(ds(e).getComputedStyle(e).paddingRight,10)||0,sy=e=>{const t=e,n=[];if((l=>{const a=cs(l);return a.body===l?ds(l).innerWidth>a.documentElement.clientWidth:l.scrollHeight>l.clientHeight})(t)){n.push({value:t.style.paddingRight,property:"padding-right",el:t}),t.style.paddingRight=`${xd(t)+Ii()}px`;const l=cs(t).querySelectorAll('*[style="position:fixed"]');[].forEach.call(l,a=>{n.push({value:a.style.paddingRight,property:"padding-right",el:a}),a.style.paddingRight=`${xd(a)+Ii()}px`})}const r=t.parentElement,o=ds(t),i=(r==null?void 0:r.nodeName)==="HTML"&&o.getComputedStyle(r).overflowY==="scroll"?r:t;return n.push({value:i.style.overflow,property:"overflow",el:i},{value:i.style.overflowX,property:"overflow-x",el:i},{value:i.style.overflowY,property:"overflow-y",el:i}),i.style.overflow="hidden",()=>{n.forEach(({value:l,el:a,property:s})=>{l?a.style.setProperty(s,l):a.style.removeProperty(s)})}};function Gl(e,t){let n=-1;return e.some((r,o)=>!!t(r)&&(n=o,!0)),n}const Ql=new class{constructor(){ml(this,"containers");ml(this,"modals");this.modals=[],this.containers=[]}add(e,t){let n=this.modals.indexOf(e);if(n!==-1)return n;n=this.modals.length,this.modals.push(e);const r=Gl(this.containers,o=>o.container===t);return r!==-1?(this.containers[r].modals.push(e),n):(this.containers.push({modals:[e],container:t,restore:null}),n)}mount(e){const t=Gl(this.containers,r=>r.modals.indexOf(e)!==-1),n=this.containers[t];n.restore||(n.restore=sy(n.container))}remove(e){const t=this.modals.indexOf(e);if(t===-1)return t;const n=Gl(this.containers,o=>o.modals.indexOf(e)!==-1),r=this.containers[n];return r.modals.splice(r.modals.indexOf(e),1),this.modals.splice(t,1),r.modals.length===0&&(r.restore&&r.restore(),this.containers.splice(n,1)),t}},uy=j.div`
  display: flex;
  align-items: center;
...
`,dy=j.h5`
  ${({$mobile:e})=>e?he["Header/H6"]:he["Header/H5"]};
...
`;const hy=j.div`
  ...
  ${({$mobile:e})=>e?he["Body/Body 2 Long"]:he["Body/Body 1 Long"]}
  color: ${({theme:e})=>e.color["Neutral/Neutral 90"]};
  outline: none;
`,my=j(O1)`
  position: absolute;
...
`,gy=_``,pl=x.createContext({mobile:!1,displayCloseIcon:!0}),Sh=x.forwardRef(({overlayStyledCss:e=gy,overlayClassName:t,overlayStyle:n,dimension:r="l",container:o,mobile:i=!1,onClose:l,closeOnEscapeKeyDown:a,closeOnOutsideClick:s,displayCloseIcon:c=!0,children:d,locale:f,...h},v)=>{const g=ih()||mu,$=(f==null?void 0:f.closeButtonAriaLabel)||g.locales[g.currentLocale].modal.closeButtonAriaLabel,k=x.useRef({}),p=x.useRef(null),u=x.useRef(null),m=x.useRef(null),w=()=>(k.current.modalEl=p.current,k.current.containerEl=o||document.body,k.current);return x.useLayoutEffect(()=>{var S;return m.current=document.activeElement,(S=p.current)==null||S.focus(),Ql.add(w(),o||document.body),p.current&&Ql.mount(w()),()=>{var E;(E=m.current)==null||E.focus(),Ql.remove(w())}},[]),ll.createPortal(y.jsx(uy,{ref:u,tabIndex:-1,onMouseDown:S=>{s&&S.target===u.current&&(l==null||l())},onKeyDown:S=>{if(S.key==="Escape"&&a)S.preventDefault(),S.stopPropagation(),l==null||l();else if(S.key==="Tab"){const E=ly(p.current);S.shiftKey?document.activeElement!==E[0]&&document.activeElement!==p.current||(E[E.length-1].focus(),S.preventDefault()):document.activeElement===E[E.length-1]&&(E[0].focus(),S.preventDefault())}},$overlayStyledCss:e,className:t,style:n,children:y.jsxs(hy,{ref:Ct(v,p),tabIndex:-1,role:"dialog","aria-modal":!0,$dimension:r,$mobile:i,...h,children:[y.jsx(pl.Provider,{value:{mobile:i,displayCloseIcon:c},children:d}),c&&y.jsx(my,{dimension:"lSmall","aria-label":$,$mobile:i,onClick:S=>{S.stopPropagation(),l==null||l()}})]})}),o||document.body)});Sh.displayName="Modal";const vy=({children:e,...t})=>{const{mobile:n,displayCloseIcon:r}=x.useContext(pl);return y.jsx(dy,{$mobile:n,$displayCloseIcon:r,as:n?"h6":"h5",...t,children:e})},yy=({children:e,...t})=>{const n=x.useRef(null),[r,o]=x.useState(!1),[i,l]=x.useState(0),a=x.useContext(pl).mobile;return x.useLayoutEffect(()=>{n.current&&$n(n.current)!==r&&(l(n.current.offsetWidth-n.current.clientWidth),o($n(n.current)))},[e,r,o]),x.useLayoutEffect(()=>{if(n.current){const s=new ResizeObserver(()=>{n.current&&$n(n.current)!==r&&(l(n.current.offsetWidth-n.current.clientWidth),o($n(n.current)))});return s.observe(n.current),()=>{s.disconnect()}}},[r,o]),y.jsx(fy,{tabIndex:-1,ref:n,$scrollbar:r?i:0,$mobile:a,...t,children:e})},xy=({children:e,...t})=>{const n=x.useContext(pl).mobile;return y.jsx(py,{$mobile:n,...t,children:e})};var wd;function fs(){return fs=Object.assign?Object.assign.bind():function(e){for(var t=1;t<arguments.length;t++){var n=arguments[t];for(var r in n)Object.prototype.hasOwnProperty.call(n,r)&&(e[r]=n[r])}return e},fs.apply(this,arguments)}var wy=function(e){return x.createElement("svg",fs({xmlns:"http://www.w3.org/2000/svg",fill:"none",viewBox:"0 0 24 24"},e),wd||(wd=x.createElement("path",{fill:"#717681",d:"M6.03 12.44a.645.645 0 0 1-.21-.48c0-.16.05-.31.17-.44l5.49-6.04c.28-.31.76-.31 1.04 0l5.49 6.04c.24.27.22.68-.04.92a.65.65 0 0 1-.92-.04l-4.4-4.835V18.46a.65.65 0 1 1-1.3 0V7.565L6.95 12.4c-.24.26-.65.28-.92.04Z"})))};const $h=_`
...
`,Sy=_`
  color: ${({theme:e})=>e.color["Neutral/Neutral 90"]};
  ${({$dimension:e})=>e==="l"||e==="xl"?he["Body/Body 1 Short"]:he["Body/Body 2 Short"]}
`,$y=_`
  color: ${({theme:e})=>e.color["Neutral/Neutral 90"]};
  ${({$dimension:e})=>e==="l"||e==="xl"?he["Subtitle/Subtitle 2"]:he["Subtitle/Subtitle 3"]}
`,ky=_`
  color: ${({theme:e})=>e.color["Neutral/Neutral 90"]};
  ${({$dimension:e})=>e==="l"||e==="xl"?he["Subtitle/Subtitle 2"]:he["Subtitle/Subtitle 3"]}
`,Ey=_`
  color: ${({theme:e})=>e.color["Neutral/Neutral 50"]};
  ${({$dimension:e})=>e==="l"||e==="xl"?he["Body/Body 2 Long"]:he["Caption/Caption 1"]}
`,kh=_`
  display: inline-block;
  overflow: hidden;
  text-overflow: ellipsis;
...
`;function Sd({name:e,disabled:t,dimension:n,columnMinWidth:r,onChange:o}){const i=x.useRef(null),l=x.useRef(0),[a,s]=x.useState(!1),c=g=>{var u,m;g.preventDefault();const $=((m=(u=i.current)==null?void 0:u.parentElement)==null?void 0:m.getBoundingClientRect().width)||100,k=g.changedTouches?g.changedTouches[0].clientX:g.clientX;let p=$-(l.current-k);p=p>=r?p:r,$!==p&&o({name:e,width:p}),l.current=k},d=g=>{g.preventDefault(),g.stopPropagation(),s(!0),l.current=g.changedTouches?g.changedTouches[0].clientX:g.clientX},f=g=>{a&&(c(g),s(!1))},[h,v]=ry(g=>{a&&c(g)},100);return x.useEffect(()=>{if(!t)return document.addEventListener("mousemove",h),document.addEventListener("mouseup",f),document.addEventListener("touchmove",h),document.addEventListener("touchend",f),()=>{v(),document.removeEventListener("mousemove",h),document.removeEventListener("mouseup",f),document.removeEventListener("touchmove",h),document.removeEventListener("touchend",f)}}),x.useEffect(()=>{const g=i.current;if(!t&&g)return g.addEventListener("mousedown",d),g.addEventListener("touchstart",d),()=>{g.removeEventListener("mousedown",d),g.removeEventListener("touchstart",d)}},[t]),y.jsx(Nh,{ref:i,disabled:t,$dimension:n,children:y.jsx(_y,{})})}const Th=j.div`
  position: relative;
  box-sizing: border-box;
  display: flex;
  flex-direction: column;
...
`,Zy=j(Fh)`
  ...
  background: ${({theme:e})=>e.color["Neutral/Neutral 00"]};
  color: ${({theme:e})=>e.color["Neutral/Neutral 90"]};
  ${({$dimension:e})=>e==="s"||e==="m"?he["Subtitle/Subtitle 3"]:he["Subtitle/Subtitle 2"]}
...
`,qy=j.div`
  ...
  overflow: hidden;
  text-overflow: ellipsis;
`,Jy=({row:e,dimension:t,displayRowSelectionColumn:n,checkboxDimension:r,renderCell:o,onRowExpansionChange:i,onRowSelectionChange:l,indeterminate:a,checked:s})=>{var c,d;return y.jsxs(y.Fragment,{children:[y.jsxs(_h,{children:[y.jsx(Hi,{$dimension:t,className:"td_expand","data-column":"expand","data-row":e.id,children:y.jsx(jh,{dimension:t==="s"||t==="m"?"mBig":"lBig",disabled:!(!e.disabled&&((c=e.groupRows)==null?void 0:c.length)!==0)||void 0,highlightFocus:!1,onClick:f=>{f.stopPropagation(),i==null||i(e.id)},children:y.jsx(Mh,{$isOpened:e.expanded,"aria-hidden":!0})})}),n&&y.jsx(Wi,{$dimension:t,className:"td_checkbox","data-column":"checkbox","data-row":e.id,children:y.jsx(So,{disabled:e.disabled||e.checkboxDisabled||((d=e.groupRows)==null?void 0:d.length)===0,dimension:r,checked:!!s,indeterminate:a,onChange:()=>{l==null||l(e.id)},onClick:f=>{f.stopPropagation()}})}),y.jsx(_o,{$dimension:t,className:"td","data-column":"group","data-row":e.id,children:e.renderGroupTitle?e.renderGroupTitle(e):o?o(e,"group"):y.jsx(Ay,{children:e.groupTitle||""})},`${e.id}`)]}),y.jsx(Su,{})]})},ex=({row:e,dimension:t,checkboxDimension:n,columns:r,stickyColumns:o,displayRowSelectionColumn:i,displayRowExpansionColumn:l,onRowExpansionChange:a,onRowSelectionChange:s,renderBodyCell:c})=>y.jsxs(y.Fragment,{children:[(i||l||o.length>0)&&y.jsxs(ps,{children:[l&&y.jsx(Hi,{$dimension:t,className:"td_expand","data-column":"expand","data-row":e.id,children:e.expandedRowRender&&y.jsx(jh,{style:{margin:0,flexShrink:0},dimension:t==="s"||t==="m"?"mBig":"lBig",disabled:!!e.disabled||void 0,highlightFocus:!1,onClick:d=>{d.stopPropagation(),a==null||a(e.id)},children:y.jsx(Mh,{$isOpened:e.expanded,"aria-hidden":!0})})}),i&&y.jsx(Wi,{$dimension:t,className:"td_checkbox","data-column":"checkbox","data-row":e.id,children:y.jsx(So,{disabled:e.disabled||e.checkboxDisabled,dimension:n,checked:!!e.selected,onChange:()=>s==null?void 0:s(e.id),onClick:d=>{d.stopPropagation()}})}),o.length>0&&o.map(d=>c(e,d))]}),r.map(d=>d.sticky?null:c(e,d)),y.jsx(Su,{})]}),tx=({tableWidth:e,row:t,dimension:n,verticalScroll:r,scrollbar:o,showRowsActions:i,...l})=>{var s;const a=x.useRef(null);return y.jsx(Bi,{ref:a,"data-overflowmenu":!0,"data-opened":i,$offset:e-(r?o:0),$dimension:n,$showRowsActions:i,...l,children:t.actionRender?t.actionRender(t):(s=t.overflowMenuRender)==null?void 0:s.call(t,t,c=>{i||(c?a.current&&(a.current.dataset.opened="true"):a.current&&(a.current.dataset.opened="false"))})})},nx=({children:e,in:t=!1,timeout:n=300,onEnter:r,onEntering:o,onEntered:i,onExit:l,onExiting:a,onExited:s,...c})=>{const[d,f]=x.useState(t?"entered":"exited"),h=x.useRef(t?"entered":"exited"),v=x.useRef(0);x.useEffect(()=>()=>{u()},[]),x.useEffect(()=>{let w=null;t?h.current!=="entering"&&h.current!=="entered"&&(w="entering"):h.current!=="entering"&&h.current!=="entered"||(w="exiting"),$(w)},[t]),x.useEffect(()=>{if(h.current!==d){h.current=d;const{enter:w,exit:S}=g();d=="entering"?(o==null||o(),m(w,()=>{f("entered")})):d=="exiting"?(a==null||a(),m(S,()=>{f("exited")})):d=="entered"?i==null||i():d=="exited"&&(s==null||s())}},[d]);const g=()=>{let w,S;return typeof n=="number"?w=S=n:(w=n.exit,S=n.enter),{exit:w,enter:S}},$=w=>{w!==null&&(u(),w==="entering"?k():p())},k=()=>{r==null||r(),f("entering")},p=()=>{l==null||l(),f("exiting")},u=()=>{clearTimeout(v.current)},m=(w,S)=>{v.current=setTimeout(S,w)};return y.jsx(y.Fragment,{children:typeof e=="function"?e(d,c):x.cloneElement(x.Children.only(e),c)})},rx=({row:e,rowRef:t})=>{var i;const n=x.useRef(null),r=x.useRef(null);x.useEffect(()=>{o(e.expanded?"auto":"0px")},[]);const o=l=>{var c;const a=(((c=r.current)==null?void 0:c.clientHeight)||0)+"px",s=l??a;n.current&&(n.current.style.height=s)};return y.jsx(nx,{in:!!e.expanded,timeout:250,onEnter:()=>{o("0px")},onEntered:()=>{o("auto")},onEntering:()=>{o()},onExit:()=>{o()},onExiting:()=>{o("0px")},children:y.jsx(Gy,{ref:n,className:"tr-expanded",onMouseEnter:()=>{var l;(l=t.current)==null||l.classList.remove("hoverable")},onMouseLeave:()=>{var l;(l=t.current)==null||l.classList.add("hoverable")},children:y.jsx(Qy,{ref:r,children:(i=e.expandedRowRender)==null?void 0:i.call(e,e)})})})},ox=({row:e,dimension:t,underline:n,onRowClick:r,onRowDoubleClick:o,children:i,tableWidth:l,isGroup:a,rowWidth:s,verticalScroll:c,scrollbar:d,grey:f,showRowsActions:h,rowStatusMap:v,...g})=>{const $=x.useRef(null);return y.jsxs(zh,{...g,ref:$,onClick:()=>{return k=e.id,void(r==null?void 0:r(k));var k},onDoubleClick:()=>{return k=e.id,void(o==null?void 0:o(k));var k},$underline:n,disabled:!!e.disabled,$dimension:t,className:`tr ${e.className||""} hoverable`,"data-row":e.id,$isGroup:a,$rowWidth:s,$hover:!!e.hover,children:[y.jsx(Vy,{className:"tr-simple",$showRowsActions:h,selected:!!e.selected,disabled:!!e.disabled,$status:e.status,$rowStatusMap:v,$error:!!e.error,$success:!!e.success,$grey:!!f,children:i}),(h||e.overflowMenuRender||e.actionRender)&&y.jsx(tx,{dimension:t,tableWidth:l,row:e,verticalScroll:c,scrollbar:d,onClick:k=>{k.stopPropagation()},showRowsActions:h}),e.expandedRowRender&&y.jsx(rx,{row:e,rowRef:$})]})},ix=_`
  & *[fill^='#'] {
    fill: ${({theme:e})=>e.color["Primary/Primary 60 Main"]};
  }
`,lx=j.button`
...
`,sx=x.forwardRef(({dimension:e,renderFilterIcon:t,isFilterActive:n,...r},o)=>{const i=e==="s"||e==="m"?"16px":"20px",l=x.useRef(null);return x.useEffect(()=>{const a=l.current;function s(c){c.stopPropagation()}if(a)return a.addEventListener("mousemove",s),a.addEventListener("touchmove",s),()=>{a.removeEventListener("mousemove",s),a.removeEventListener("touchmove",s)}},[]),y.jsx(lx,{ref:Ct(o,l),type:"button",...r,children:y.jsx(ax,{$isFilterActive:n,$iconSize:i,children:t?t():y.jsx(ay,{"aria-hidden":!0})})})}),ux=j(xh)`
  background-color: ${e=>e.theme.color["Special/Elevated BG"]};
`,cx=x.forwardRef(({column:e,targetElement:t,...n},r)=>{const{renderFilter:o,renderFilterIcon:i,onFilterMenuClickOutside:l,onFilterMenuOpen:a,onFilterMenuClose:s,isFilterActive:c,filterMenuAlignSelf:d="flex-end",filterMenuCssMixin:f,filterMenuClassName:h,filterMenuStyle:v}=e,[g,$]=x.useState(!1),[k,p]=x.useState(!1),u=x.useRef(null),m=()=>{var w;$(!1),s==null||s(),(w=u.current)==null||w.focus()};return y.jsxs(y.Fragment,{children:[y.jsx(sx,{ref:Ct(r,u),onKeyDown:w=>{const S=O.getCode(w);S!==O.ArrowDown&&S!==O.Enter&&S!==O[" "]||($(!0),a==null||a(),w.preventDefault())},onClick:()=>{$(w=>(w?s==null||s():a==null||a(),!w))},"aria-expanded":g,"aria-haspopup":g,isFilterActive:c??k,renderFilterIcon:i,...n}),g&&y.jsx(ux,{role:"listbox",targetElement:t,alignSelf:d,onClickOutside:w=>{var S;w.target&&((S=u.current)!=null&&S.contains(w.target))||(l==null||l({closeMenu:m,setFilterActive:p},w))},onKeyDown:w=>{const S=O.getCode(w);S!==O.Escape&&S!==O.Tab||m()},dropContainerCssMixin:f,className:h,style:v,children:o==null?void 0:o({closeMenu:m,setFilterActive:p},e)})]})}),$d=({lineClamp:e,dimension:t,extraText:n,title:r})=>{const o=x.useRef(null),[i,l]=x.useState(!1),[a,s]=x.useState(!1),c=typeof r=="string"||typeof r=="number";return x.useLayoutEffect(()=>{const d=o.current;d&&$n(d)!==i&&l($n(d))},[a,l]),x.useLayoutEffect(()=>{function d(){s(!0)}function f(){s(!1)}const h=o.current;if(h)return h.addEventListener("mouseenter",d),h.addEventListener("mouseleave",f),()=>{h.removeEventListener("mouseenter",d),h.removeEventListener("mouseleave",f)}},[s]),y.jsxs(y.Fragment,{children:[n?y.jsx(Wy,{ref:o,$dimension:t,$lineClamp:e,children:r}):y.jsx(By,{ref:o,$lineClamp:e,children:r}),i&&a&&c&&y.jsx(vu,{targetElement:o.current,renderContent:()=>r})]})},dx=({sort:e,sortOrder:t,multipleSort:n,iconSize:r})=>{const o=x.useRef(null);return x.useEffect(()=>{const i=o.current;function l(a){a.stopPropagation()}if(i)return i.addEventListener("mousemove",l),i.addEventListener("touchmove",l),()=>{i.removeEventListener("mousemove",l),i.removeEventListener("touchmove",l)}},[]),y.jsxs(Ly,{ref:o,children:[y.jsx(zy,{$sort:e||"initial",width:r,height:r}),n&&e&&t&&y.jsx(Oh,{children:t})]})},fx=100,px=({column:e,columnsAmount:t,showDividerForLastColumn:n,disableColumnResize:r,headerLineClamp:o,headerExtraLineClamp:i,spacingBetweenItems:l,dimension:a,handleResizeChange:s,handleSort:c,multipleSort:d,columnMinWidth:f,index:h})=>{const{name:v,title:g,extraText:$,width:k=fx,cellAlign:p="left",sortable:u=!1,sort:m,sortOrder:w,disableResize:S=!1,draggable:E=!1,renderFilter:P}=e,T=a==="s"||a==="m"?16:20,W=a==="l"||a==="xl"?"16px":"12px",A=l||W,K=typeof k=="number"?k+"px":k,le=x.useRef(null);return y.jsxs(Fh,{$dimension:a,style:{width:K,minWidth:K},className:"th","data-draggable":E,"data-th-column":v,"data-th-title":g,ref:le,children:[y.jsxs(Dy,{$cellAlign:p,children:[y.jsxs(Lh,{$sort:m||"initial",onClick:u?()=>c(v,m||"initial"):void 0,children:[y.jsxs(by,{$dimension:a,$sortable:u,children:[y.jsx($d,{dimension:a,lineClamp:o,title:g}),$&&y.jsx($d,{extraText:!0,dimension:a,lineClamp:i,title:$})]}),u&&y.jsx(dx,{sort:m,sortOrder:w,multipleSort:d,iconSize:T})]}),y.jsx(Iy,{width:P?A:parseInt(A)-parseInt(W)+"px"}),P&&y.jsx(cx,{column:e,dimension:a,targetElement:le.current})]}),h<t-1&&y.jsx(Sd,{name:v,onChange:s,disabled:S||r,dimension:a,columnMinWidth:f}),h===t-1&&n&&y.jsx(Sd,{name:v,onChange:s,disabled:S||r,dimension:a,columnMinWidth:f})]})};function hx(e,t,n,r,o){let i,l,a,s,c,d,f,h,v,g=null,$=null;const k={...t,direction:t.direction??"horizontal",accepts:t.accepts??mx,invalid:t.invalid??gx,containers:[...e]},p={containers:k.containers,unobserve:function(){m(!0),A({})},dragging:!1};return m(),p;function u(D){return p.containers.indexOf(D)!==-1}function m(D){const b=D?"remove":"add";Or(document.documentElement,b,"mousedown",P),Or(document.documentElement,b,"mouseup",A)}function w(D){const b=D?"remove":"add";Or(document.documentElement,b,"mousemove",T)}function S(D){ms[D?"remove":"add"](document.documentElement,"click",E)}function E(D){h&&D.preventDefault()}function P(D){const b=function(C){if(p.dragging&&i||u(C))return;const F=C;for(;mn(C)&&u(mn(C))===!1;)if(k.invalid(C,F)||!(C=mn(C)))return;const L=mn(C);if(L&&!k.invalid(C,F))return{item:C,source:L}}(D.target);b&&(h=b,w(),D.type==="mousedown"&&D.preventDefault())}function T(D){if(!h||D.movementX==0&&D.movementY==0)return;const b=h;var C;if(w(!0),S(),function(){p.dragging&&K()}(),l=(C=b).source,a=C.item,$=C.item,d=f=C.item.nextElementSibling,p.dragging=!0,r==null||r(),a){const F=function(L){const I=L.getBoundingClientRect();return{left:I.left+window.scrollX,top:I.top+window.scrollY}}(a);s=Dn("pageX",D)-F.left,c=Dn("pageY",D)-F.top,a.dataset.dragover="true",function(){const L=k.mirrorRef.current;if(!(i&&!L)&&L&&k.direction==="horizontal"){const I=L.parentElement,U=a.dataset.thTitle??"";L.lastElementChild&&(L.lastElementChild.innerHTML=U),L.style.visibility="visible",i=k.mirrorRef.current,Or(document.documentElement,"add","mousemove",X),I&&(v=I.style.userSelect,I.style.userSelect="none")}}(),X(D)}}function W(){h=!1,w(!0),S(!0)}function A(D){if(W(),!p.dragging)return;const b=Dn("clientX",D)||0,C=Dn("clientY",D)||0,F=le(kd(i,b,C),b,C);F&&F!==l?K():function(){p.dragging&&K()}()}function K(){W(),function(){const D=k.mirrorRef.current;if(i&&D){const b=D.parentElement;b&&(b.style.userSelect=v),D.style.visibility="hidden",Or(document.documentElement,"remove","mousemove",X),i=null}}(),a&&delete a.dataset.dragover,p.dragging=!1,o==null||o(),l=a=d=f=g=$=null}function le(D,b,C){let F=D;for(;F&&!L();)F=mn(F);return F;function L(){if(u(F)===!1)return!1;const I=fe(F,D),U=Z(F,I,b,C);return!!function(te,re){let ge;return ge=re!==void 0?re:i?f:a==null?void 0:a.nextElementSibling,te===l&&ge===d}(F,U)||k.accepts(a,F,l,U)}}function X(D){if(!i)return;D.preventDefault();const b=Dn("clientX",D)||0,C=Dn("clientY",D)||0;let F,L;k.direction==="vertical"?(F=b-s,L=C-c):k.direction==="horizontal"&&(F=b-(k.dimension==="s"||k.dimension==="m"?18:20),L=C-i.getBoundingClientRect().height/2),i.style.left=F+"px",i.style.top=L+"px";const I=kd(i,b,C),U=le(I,b,C),me=U!==null&&U!==g;let te;(me||U===null)&&(g=U),i.dataset.cursor=U==null?"error":"normal";const re=fe(U,I);if($!=null&&$.isEqualNode(re)||re==null)$=re;else if($=re,te=Z(U,re,b,C),a&&(te===null&&me||te!==a&&te!==a.nextElementSibling)){if(f=te,a.nextElementSibling===null&&te===null)return;n==null||n(a,te)}}function fe(D,b){let C=b;for(;C!==D&&mn(C)!==D;)C=mn(C);return C===document.documentElement?null:C}function Z(D,b,C,F){const L=k.direction==="horizontal",I=a==null?void 0:a.getBoundingClientRect().right;return b!==D?function(){const me=b.getBoundingClientRect();return U(L&&typeof I=="number"?C>=me.left&&C<me.right&&I<=C:F>me.top+me.height/2)}():function(){const me=D.children.length;for(let te=0;te<me;te++){const re=D.children[te],ge=re.getBoundingClientRect();if(L&&typeof I=="number"&&C>=ge.left&&C<ge.right)return I<=C?re.nextElementSibling:re;if(!L&&ge.top+ge.height/2>F)return re}return null}();function U(me){return me?b.nextElementSibling:b}}}const ms={add:function(e,t,n,r){return e.addEventListener(t,n,r)},remove:function(e,t,n,r){return e.removeEventListener(t,n,r)}};function Or(e,t,n,r){ms[t](e,{mouseup:"touchend",mousedown:"touchstart",mousemove:"touchmove"}[n],r),ms[t](e,n,r)}function kd(e,t,n){const r=e.style.pointerEvents;e.style.pointerEvents="none";const o=document.elementFromPoint(t,n);return e.style.pointerEvents=r,o}function mx(){return!0}function gx(){return!1}function mn(e){return e.parentNode===document?null:e.parentNode}function Dn(e,t){return function(r){return r.targetTouches&&r.targetTouches.length?r.targetTouches[0]:r.changedTouches&&r.changedTouches.length?r.changedTouches[0]:r}(t)[e]}const vx=({onColumnDrag:e,dimension:t,isAnyColumnDraggable:n,isAnyStickyColumnDraggable:r,tableRef:o,scrollBodyRef:i,normalColumnsWrapperRef:l,stickyColumnsWrapperRef:a})=>{const{rootRef:s}=x.useContext(To),[c,d]=x.useState(!1),f=x.useRef(e),h=x.useRef(null);return x.useEffect(()=>{f.current=e},[e]),x.useEffect(()=>{o.current&&(o.current.dataset.dragging=String(c))},[c]),x.useEffect(()=>{if(h.current&&c&&(n||r)){const v=gu(h.current,g=>{var p,u,m;const $=((p=o.current)==null?void 0:p.getBoundingClientRect().right)||0,k=((u=a.current)==null?void 0:u.getBoundingClientRect().right)||((m=o.current)==null?void 0:m.getBoundingClientRect().left)||0;if(i.current){const w=i.current.scrollLeft,S=i.current.scrollWidth,E=i.current.offsetWidth;g.right>$&&S>E&&w+E<S&&i.current.scrollBy({left:Math.abs($-g.right)}),g.left<k&&w>0&&i.current.scrollBy({left:-Math.abs(k-g.left)})}});return v.observe(),()=>v.unobserve()}},[n,r,c]),x.useEffect(()=>{const v=a.current,g=l.current;if(g&&n){const $=hx([g],{mirrorRef:h,dimension:t,direction:"horizontal",invalid:k=>k.dataset.draggable=="false",accepts:(k,p,u,m)=>p===u&&(m==null?void 0:m.dataset.droppable)!="false"},function(k,p){var m,w,S,E,P,T;const u=(m=k==null?void 0:k.dataset)==null?void 0:m.thColumn;u&&(v!=null&&v.contains(k)&&p===null?(E=f.current)==null||E.call(f,u,((S=(w=g==null?void 0:g.firstElementChild)==null?void 0:w.dataset)==null?void 0:S.thColumn)??null):(T=f.current)==null||T.call(f,u,((P=p==null?void 0:p.dataset)==null?void 0:P.thColumn)??null))},function(){d(!0)},function(){d(!1)});return v&&r&&$.containers.push(v),()=>{$.unobserve()}}},[n,r,t]),n||r?ll.createPortal(y.jsx(Zy,{$dimension:t,ref:h,children:y.jsx(qy,{})}),(s==null?void 0:s.current)||document.body):null},Ed=j.div`
  display: flex;
  flex: 0 0 auto;
`,yx=x.forwardRef(({height:e,childHeight:t,renderAhead:n=20,rowList:r,renderRow:o,...i},l)=>{const[a,s]=x.useState(0),c=x.useRef(null);x.useEffect(()=>{function p(m){requestAnimationFrame(()=>{s(m.target.scrollTop)})}const u=c.current;return s((u==null?void 0:u.scrollTop)||0),u==null||u.addEventListener("scroll",p),()=>u==null?void 0:u.removeEventListener("scroll",p)},[]);let d=Math.floor(a/t)-n;d=Math.max(0,d);const f=x.useMemo(()=>r.map((p,u)=>o(p,u)).filter(Boolean),[r,o]),h=f.length;let v=Math.ceil(e/t)+2*n;v=Math.min(h-d,v);const g=d*t+"px",$=(h-d-v)*t+"px",k=x.useMemo(()=>[...f].slice(d,d+v),[f,d,v]);return y.jsxs(hs,{style:{height:e},ref:Ct(l,c),...i,children:[y.jsx(Ed,{style:{minHeight:g}}),k,y.jsx(Ed,{style:{minHeight:$}})]})}),xx={error:e=>e["Error/Error 20"],success:e=>e["Success/Success 20"]},Rh=x.forwardRef(({columnList:e,rowList:t,displayRowSelectionColumn:n=!1,displayRowExpansionColumn:r=!1,headerCheckboxChecked:o=!1,headerCheckboxIndeterminate:i=!1,headerCheckboxDisabled:l=!1,onHeaderSelectionChange:a,onRowSelectionChange:s,onRowExpansionChange:c,onRowClick:d,onRowDoubleClick:f,onSortChange:h,onColumnResize:v,renderCell:g,renderRowWrapper:$,dimension:k="m",greyHeader:p=!1,greyZebraRows:u=!1,spacingBetweenItems:m,headerLineClamp:w=1,headerExtraLineClamp:S=1,showDividerForLastColumn:E=!1,disableColumnResize:P=!1,showLastRowUnderline:T=!0,showRowsActions:W=!1,virtualScroll:A,locale:K,onColumnDrag:le,rowBackgroundColorByStatusMap:X,...fe},Z)=>{const D=ih()||mu,b=k==="s"||k==="m"?"s":"m",C=k==="s"||k==="m"?25:33,[F,L]=x.useState(!1),[I,U]=x.useState(0),[me,te]=x.useState(0),[re,ge]=x.useState(0),Ee=[...e].filter(N=>N.sticky),Nt=e.filter(N=>!N.sticky&&N.draggable).length>0,wr=e.filter(N=>N.sticky&&N.draggable).length>0,pn=x.useMemo(()=>t.some(N=>N.actionRender||N.overflowMenuRender)&&W,[t,W]),yt=x.useMemo(()=>({...xx,...X}),[X]),hn=x.useRef(null),Tt=x.useRef(null),Sr=x.useRef(null),ut=x.useRef(null),$u=x.useRef(null),ku=x.useRef(null),xt=t.reduce((N,z)=>(z.groupRows!==void 0&&(N[z.id]={rows:[...z.groupRows],expanded:!!z.expanded}),N),{}),Ie=Object.entries(xt).reduce((N,[z,B])=>(B.rows.forEach(H=>{const V=t.find(ae=>ae.id.toString()===H);V&&!xt[H]&&(N[H]={groupId:z,checked:!!V.selected})}),N),{}),bt=x.useMemo(()=>(()=>{const N=[];return t.forEach(z=>{const B=!!xt[z.id];Ie[z.id]||N.push(z),B&&xt[z.id].rows.forEach(H=>{const V=t.find(ae=>ae.id.toString()===H);V&&N.push(V)})}),N})(),[t]),Ah=u?bt.reduce((N,z,B)=>{if(Ie[z.id]){const H=xt[Ie[z.id].groupId].rows.indexOf(String(z.id));N[z.id]="ingroup "+(H%2==0?"odd":"even")}else xt[z.id]?N[z.id]="group":B===0||N[bt[B-1].id].includes("group")?N[z.id]="odd":N[z.id]=N[bt[B-1].id]==="odd"?"even":"odd";return N},{}):{};x.useLayoutEffect(()=>{var N;if(Sr.current){const z=(N=Sr.current)==null?void 0:N.querySelectorAll(".th"),B=new ResizeObserver(H=>{H.forEach(V=>{var J,oe;const ae=(J=ut.current)==null?void 0:J.querySelectorAll(`[data-column="${V.target.dataset.thColumn}"]`);ae==null||ae.forEach(Bt=>{Bt.style.width=V.borderBoxSize[0].inlineSize+"px"});const se=(oe=Tt.current)==null?void 0:oe.querySelectorAll(`[data-th-column="${V.target.dataset.thColumn}"]`);se==null||se.forEach(Bt=>{Bt.style.width=V.borderBoxSize[0].inlineSize+"px",Bt.style.minWidth=V.borderBoxSize[0].inlineSize+"px"})})});return z==null||z.forEach(H=>B.observe(H)),()=>{B.disconnect()}}},[Sr.current,Tt.current,ut.current,e,t]),x.useEffect(()=>{const N=Ii();ge(N)},[ge]),x.useLayoutEffect(()=>{const N=ut.current;function z(H){var V;if(ut.current){const ae=ut.current.querySelectorAll("[data-overflowmenu]"),se=F?re:0,J=((V=Tt.current)==null?void 0:V.scrollWidth)||I;ae.forEach(oe=>{oe.style.marginLeft=H<=J-I+se?`${H}px`:`${J-I+se}px`})}}function B(H){H.target===ut.current&&requestAnimationFrame(function(){var V;V=H.target.scrollLeft,Tt.current&&(Tt.current.scrollLeft=V),z(H.target.scrollLeft)}),(Ee.length>0||n||r)&&requestAnimationFrame(function(){(function(V){if(hn.current){const ae=hn.current.getAttribute("data-shadow");V===0?ae!=="false"&&hn.current.setAttribute("data-shadow","false"):ae!=="true"&&hn.current.setAttribute("data-shadow","true")}})(H.target.scrollLeft)})}if(N){N.addEventListener("scroll",B);const H=gu(N,V=>{N.scrollHeight>N.offsetHeight?L(!0):L(!1),U(V.width),te(V.height),z(N.scrollLeft)});return H.observe(),()=>{N.removeEventListener("scroll",B),H.unobserve()}}},[hn.current,Tt.current,ut.current,Ee,r,n,I,re,F,U,L,te]);function Eu(N){const z=xt[N],B=Ie[N],H=z&&(se=>{const J=se.rows.some(oe=>Ie[oe].checked)&&se.rows.some(oe=>!Ie[oe].checked);return{checked:se.rows.every(oe=>Ie[oe].checked),indeterminate:J}})(z),V=B&&(se=>{var $r;const J=($r=Ie[se])==null?void 0:$r.groupId,oe=J?xt[J]:void 0;if(!oe)return;const Bt=oe==null?void 0:oe.rows.some(zn=>zn===se.toString()?!Ie[zn].checked:Ie[zn].checked);return{groupId:J,value:Bt}})(N),ae=t.reduce((se,J)=>{if(z){const oe=z.rows.includes(J.id.toString());J.id===N||oe?se[J.id]=!(H!=null&&H.indeterminate||H!=null&&H.checked):se[J.id]=J.id===N?!J.selected:!!J.selected}else se[J.id]=J.id===N?!J.selected:!!J.selected,B&&J.id===(V==null?void 0:V.groupId)&&(se[J.id]=V==null?void 0:V.value);return se},{});s==null||s(ae,N)}function Pu(N){const z=t.reduce((B,H)=>{const V=H.id===N?!H.expanded:!!H.expanded;return B[H.id]=V,B},{});c==null||c(z)}const Cu=N=>N.selected,Nu=t.length>0&&t.every(Cu),hl=t.some(Cu);function Dh({name:N,width:z}){v==null||v({name:N,width:z+"px"})}const Ih=(N,z)=>{let B="initial";z==="asc"&&(B="desc"),z==="desc"&&(B="initial"),z==="initial"&&(B="asc"),h==null||h({name:N,sort:B})},bh=x.useMemo(()=>e.filter(N=>!!N.sort).length>1,[e]),Mo=(N,z)=>y.jsx(px,{column:N,index:z,columnsAmount:e.length,showDividerForLastColumn:E,disableColumnResize:P,headerLineClamp:w,headerExtraLineClamp:S,handleResizeChange:Dh,handleSort:Ih,dimension:k,spacingBetweenItems:m,multipleSort:bh,columnMinWidth:C},`head_${N.name}`),Bh=N=>(z,B)=>{var V,ae;const H=(ae=(V=Sr.current)==null?void 0:V.querySelector(`[data-th-column="${B.name}"]`))==null?void 0:ae.getBoundingClientRect().width;return y.jsx(_o,{$dimension:k,style:{width:H||"100px"},className:"td","data-column":B.name,"data-row":z.id,children:B.renderCell?B.renderCell(z[B.name],z,N):g?g(z,B.name):y.jsx(Ry,{$cellAlign:B.cellAlign,children:z[B.name]})},`${z.id}_${B.name}`)},Wh=N=>{var V,ae,se,J;const z=((V=N.groupRows)==null?void 0:V.some(oe=>Ie[oe].checked))&&((ae=N.groupRows)==null?void 0:ae.some(oe=>!Ie[oe].checked)),B=(se=N.groupRows)==null?void 0:se.length,H=B?(J=N.groupRows)==null?void 0:J.every(oe=>Ie[oe].checked):N.selected;return y.jsx(Jy,{row:N,dimension:k,checkboxDimension:b,displayRowExpansionColumn:r,displayRowSelectionColumn:n,onRowExpansionChange:Pu,onRowSelectionChange:Eu,renderCell:g,indeterminate:z,checked:H})},Hh=(N,z)=>y.jsx(ex,{row:N,dimension:k,checkboxDimension:b,columns:e,stickyColumns:Ee,displayRowExpansionColumn:r,displayRowSelectionColumn:n,renderBodyCell:Bh(z),onRowExpansionChange:Pu,onRowSelectionChange:Eu}),Tu=(N,z)=>{var se,J;const B=!!xt[N.id],H=!Ie[N.id]||xt[Ie[N.id].groupId].expanded,V=(({row:oe,isGroupRow:Bt,index:$r,tableRows:zn})=>Bt?!oe.expanded&&oe.groupRows&&$r>=zn.length-(oe.groupRows.length+1):$r===zn.length-1)({row:N,isGroupRow:B,tableRows:bt,index:z}),ae=(B||H)&&y.jsx(ox,{dimension:k,row:N,underline:V&&T||!V,tableWidth:I,isGroup:B,onRowClick:d,onRowDoubleClick:f,rowWidth:B?(se=Tt.current)==null?void 0:se.scrollWidth:void 0,verticalScroll:F,scrollbar:re,grey:(J=Ah[N.id])==null?void 0:J.includes("even"),showRowsActions:pn,rowStatusMap:yt,children:B?Wh(N):Hh(N,z)},`row_${N.id}`);return ae&&(($==null?void 0:$(N,z,ae))??ae)};return y.jsxs(Th,{ref:Ct(Z,hn),"data-shadow":!1,"data-dragging":!1,...fe,className:`table ${fe.className||""}`,children:[y.jsxs(Xy,{ref:Sr,"data-verticalscroll":F,children:[(n||r)&&y.jsxs(ps,{children:[r&&y.jsx(Hi,{$dimension:k}),n&&y.jsx(Wi,{$dimension:k,children:y.jsx(So,{dimension:b})})]}),y.jsxs(Ky,{$expansionColumn:r,$selectionColumn:n,$dimension:k,children:[Ee.length>0&&Ee.map((N,z)=>Mo(N,z)),e.map((N,z)=>N.sticky?null:Mo(N,z))]})]}),y.jsxs(Oy,{$scrollbar:re,$greyHeader:p,"data-verticalscroll":F,className:"thead",children:[y.jsxs(Fy,{$dimension:k,ref:Tt,className:"tr",children:[(n||r||Ee.length>0)&&y.jsxs(ps,{ref:$u,$greyHeader:p,children:[r&&y.jsx(Hi,{$dimension:k,"data-draggable":!1,"data-droppable":!1}),n&&y.jsx(Wi,{$dimension:k,className:"th_checkbox","data-th-column":"checkbox","data-draggable":!1,"data-droppable":!1,children:y.jsx(So,{dimension:b,checked:Nu||hl||o,indeterminate:hl&&!Nu||i,disabled:bt.length===0||l,onChange:function(N){const z=t.reduce((B,H)=>(B[H.id]=H.checkboxDisabled?!!H.selected:!hl,B),{});s==null||s(z),a==null||a(N.target.checked)}})}),Ee.length>0&&Ee.map((N,z)=>Mo(N,z))]}),y.jsx(My,{ref:ku,children:e.map((N,z)=>N.sticky?null:Mo(N,z))}),y.jsx(Su,{})]}),pn&&y.jsx(jy,{"data-overflowmenu":!0,$dimension:k,$greyHeader:p})]}),(()=>{var z;const N=(K==null?void 0:K.emptyMessage)||D.locales[D.currentLocale].table.emptyMessage;return bt.length===0?y.jsx(hs,{ref:ut,className:"tbody",children:y.jsx(zh,{$underline:T,$dimension:k,className:"tr",$rowWidth:(z=Tt.current)==null?void 0:z.scrollWidth,children:y.jsx(Yy,{$dimension:k,children:N})})}):A?y.jsx(yx,{height:me,rowList:bt,childHeight:A.fixedRowHeight,renderRow:Tu,ref:ut,className:"tbody"}):y.jsx(hs,{ref:ut,className:"tbody",children:bt.map((B,H)=>Tu(B,H))})})(),y.jsx(vx,{onColumnDrag:le,dimension:k,isAnyColumnDraggable:Nt,isAnyStickyColumnDraggable:wr,tableRef:hn,scrollBodyRef:ut,normalColumnsWrapperRef:ku,stickyColumnsWrapperRef:$u})]})});Rh.displayName="Table";const wx="/assets/VTBGroupUI-SemiBold-857165e0.ttf",Sx="/assets/VTBGroupUI-Medium-2005d97c.otf",$x="/assets/VTBGroupUI-Regular-6e523012.otf",kx=`
    @font-face {
...
`;function Ex(e){return y.jsx("style",{type:"text/css",children:kx,...e})}const Px=e=>x.createElement("svg",{xmlns:"http://www.w3.org/2000/svg",fill:"none",viewBox:"0 0 24 24",focusable:!1,...e},x.createElement("path",{fill:"#717681",d:"M14.48 9.12a.65.65 0 1 0-1.3 0v6.35a.65.65 0 0 0 1.3 0V9.12ZM10.18 8.47a.65.65 0 0 1 .65.65v6.35a.65.65 0 0 1-1.3 0V9.12a.65.65 0 0 1 .65-.65Z"}),x.createElement("path",{fill:"#717681",fillRule:"evenodd",d:"M12 2.02a.65.65 0 0 1 .65.65v1.98h7.03a.65.65 0 1 1 0 1.3h-.784l-.776 11.49a2.991 2.991 0 0 1-2.99 2.81H8.77c-1.58 0-2.89-1.23-2.99-2.81L5.023 5.95H4.33a.65.65 0 1 1 0-1.3h7.02V2.67a.65.65 0 0 1 .65-.65ZM6.378 5.95l.702 11.4c.06.9.8 1.6 1.7 1.6h6.36c.9 0 1.64-.7 1.7-1.59l.703-11.41H6.378Z",clipRule:"evenodd"})),br=j.div`
  height: 20px;
`,Cx=[{name:"tabNum",title:"Табельный номер",width:150},{name:"sName",title:"Фамилия",width:170},{name:"name",title:"Имя",width:170},{name:"fName",title:"Отчество",width:170},{name:"action",title:" "}];let Ne=[];const Nx=({pEdit:e,pTabNum:t,pSName:n,pName:r,pFName:o,onYesClick:i,onNoClick:l})=>{const[a,s]=x.useState(e),[c,d]=x.useState(t),[f,h]=x.useState(n),[v,g]=x.useState(r),[$,k]=x.useState(o);let p=a?"изменить":"добавить";return y.jsxs(y.Fragment,{children:[y.jsxs(yy,{children:["На этой форме предполагается ",p," человека",y.jsx(br,{}),y.jsx(Ir,{label:"Табельный номер",value:c,readOnly:a,onChange:u=>{d(u.target.value)}}),y.jsx(br,{}),y.jsx(Ir,{label:"фамилия",value:f,onChange:u=>{h(u.target.value)}}),y.jsx(br,{}),y.jsx(Ir,{label:"Имя",value:v,onChange:u=>{g(u.target.value)}}),y.jsx(br,{}),y.jsx(Ir,{label:"Отчество",value:$,onChange:u=>{k(u.target.value)}})]}),y.jsxs(xy,{children:[y.jsx(bi,{appearance:"primary",dimension:"m",onClick:()=>i({action:a,tabNumValue:c,sNameValue:f,nameValue:v,fNameValue:$}),children:"Сохранить"}),y.jsx(bi,{appearance:"secondary",dimension:"m",onClick:l,children:"Отмена"})]})]})},Tx=e=>{const[t,n]=x.useState(Cx),[r,o]=x.useState(!1),[i,l]=x.useState(!1),[a,s]=x.useState(""),[c,d]=x.useState(""),[f,h]=x.useState(""),[v,g]=x.useState(""),[$,k]=x.useState([]),p=({name:S,width:E})=>{const P=t.map(T=>T.name===S?{...T,width:E}:T);n(P)};function u(S,E){console.log("Удаляем tabNum="+S),fetch("./api/delete/"+S).then(P=>P.ok?P.text():Promise.reject(P)).then(P=>{let T=[],W=0;for(var A=0;A<Ne.length;A++)A!=E&&(T[W++]=Ne[A]);console.log("Удалён => "+E+" из "+Ne.length),k(T)}).catch(P=>{P.json().then(T=>alert(T.message))})}function m(S,E){const P=S.tabNum,T=S.sName,W=S.name,A=S.fName;S.tabNum=y.jsx(Za,{onClick:()=>{s(P),d(T),h(W),g(A),l(!0),o(!0)},children:S.tabNum}),S.action=y.jsx(Za,{children:y.jsx(Px,{width:20,onClick:()=>u(P,E)})})}function w(S,E,P,T,W){const A={method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tabNum:E,name:T,fname:W,sname:P})};console.log("Работаем с tabNum="+E),fetch(S?"./api/editPerson/":"./api/addPerson/",A).then(K=>K.ok?K.text():Promise.reject(K)).then(K=>{let le=JSON.parse(K),X=[],fe=!1;console.log((S?"Изменён":"Добавлен")+" => "+le.tabNum);for(var Z=0;Z<Ne.length;Z++)Ne[Z].tabNum.props.children==le.tabNum&&(Ne[Z]=le,m(Ne[Z],Z),fe=!0,console.log("Сохранили состояние name")),X[Z]=Ne[Z];fe||(X[Ne.length]=le,m(X[Ne.length],Ne.length),Ne[Ne.length]=X[Ne.length]),k(X)}).catch(K=>{K.json().then(le=>{alert(le.message)})})}return x.useEffect(()=>{fetch("./api/dataPerson").then(S=>S.ok?S.text():Promise.reject(S)).then(S=>{Ne=JSON.parse(S);for(var E=0;E<Ne.length;E++)m(Ne[E],E);k(Ne),console.log("Отрисовали таблицу")}).catch(S=>{S.json().then(E=>{alert(E.message)})})},[]),y.jsxs("div",{children:[y.jsx(bi,{onClick:()=>{l(!1),o(!0)},children:" Добавить запись"}),y.jsx(br,{}),y.jsx(Rh,{id:"persons",...e,greyHeader:!0,rowList:$,columnList:t,onColumnResize:p}),r&&y.jsxs(Sh,{...e,onClose:()=>{o(!1)},"aria-labelledby":"modal-title",children:[y.jsxs(vy,{id:"modal-title",children:[i?"Изменить":"Добавить"," человека"]}),y.jsx(Nx,{pEdit:i,pTabNum:a,pSName:c,pName:f,pFName:v,onYesClick:S=>{w(S.action,S.tabNumValue,S.sNameValue,S.nameValue,S.fNameValue),o(!1)},onNoClick:()=>o(!1)})]})]})},_x="/assets/react-35ef61ed.svg";function Mx(){return y.jsxs(y.Fragment,{children:[y.jsxs("div",{children:[y.jsx("a",{href:"https://vitejs.dev",target:"_blank",children:y.jsx("img",{src:"/vite.svg",className:"logo",alt:"Vite logo"})}),y.jsx("a",{href:"https://react.dev",target:"_blank",children:y.jsx("img",{src:_x,className:"logo react",alt:"React logo"})})]}),y.jsx("h1",{children:"Vite + React"}),y.jsx("p",{className:"read-the-docs",children:"Click on the Vite and React logos to learn more"}),y.jsxs("div",{className:"tables",children:[y.jsx("h3",{children:"Список сотрудников"}),y.jsx(Tx,{})]})]})}Yl.createRoot(document.getElementById("root")).render(y.jsx(ln.StrictMode,{children:y.jsx(g1,{theme:mu,children:y.jsxs(b1,{children:[y.jsx(Ex,{}),y.jsx(Mx,{})]})})}));
